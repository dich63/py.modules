...
def ec_test(mesh):
    ...
    r['mu']=1;
    '''
    r=mmd.region_by_name_update(mesh,'pipe1',{'sigma':1e4,'mu':1.0});

    
    
    mdec=mmd.MID3barrier_decay(mesh=mesh)#,rcoil="srcoil",gcoil="gcoil");
    ...
    ss01=mdec.decay_ms_ec2({'U':737.01,'id':'gcoil'},0);
    ss00=mdec.decay_ms_ec2();
    return 0;
