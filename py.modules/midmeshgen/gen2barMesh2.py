...
def gen2barMesh(sensor, p):
    ...
    #
    #======== pipes description =======
    tub = midu.set_region_params('tubing',p.tbg.sigma,p.tbg.mu,np.array([[p.tbg.d/2.-p.tbg.th0, p.tbg.d/2.-p.tbg.th0+p.tbg.th], [zmin,zmax]]))
    cas = midu.set_region_params('casing',p.csg.sigma,p.csg.mu,np.array([[p.csg.d/2.-p.csg.th0, p.csg.d/2.-p.csg.th0+p.csg.th], [zmin,zmax]]))
    cas2 = midu.set_region_params('casing2',p.csg2.sigma,p.csg2.mu,np.array([[p.csg2.d/2.-p.csg2.th0, p.csg2.d/2.-p.csg2.th0+p.csg2.th], [zmin,zmax]]))
    ...
    tub = midu.set_region_params('tubing',p.tbg.sigma,p.tbg.mu, [[p.tbg.d/2.-p.tbg.th0, zmin, p.tbg.d/2.-p.tbg.th0+p.tbg.th, zmax]])
    cas = midu.set_region_params('casing',p.csg.sigma,p.csg.mu, [[p.csg.d/2.-p.csg.th0, zmin, p.csg.d/2.-p.csg.th0+p.csg.th, zmax]])
    cas2 = midu.set_region_params('casing2',p.csg2.sigma,p.csg2.mu, [[p.csg2.d/2.-p.csg2.th0, zmin, p.csg2.d/2.-p.csg2.th0+p.csg2.th, zmax]])

    hull2tubing = midu.set_region_params('hull2tubing',0,1, [[21., zmin,p.tbg.d/2.-p.tbg.th0, zmax]] )

    tub2cas = midu.set_region_params('tubing2casing',0,1, [[p.tbg.d/2.-p.tbg.th0+p.tbg.th, zmin,p.csg.d/2.-p.csg.th0, zmax]])
    cas2cas2 = midu.set_region_params('casing2casing',0,1, [[ p.csg.d/2.-p.csg.th0+p.csg.th, zmin, p.csg2.d/2.-p.csg2.th0, zmax]])
    cas2inf = midu.set_region_params('casing2',0,1, [[ p.csg2.d/2.-p.csg2.th0+p.csg2.th, zmin,5000, zmax]])
    #meshes = [core, rcoil, gcoil, hull, tub, cas, cas2]
