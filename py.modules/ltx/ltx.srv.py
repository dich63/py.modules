...
from ltx.cbevent import ltx_event_set_ref
...
if __name__=='__main__':
    ...
    import os
    import sys
    from ltx.host_vm import set_vm_ref
    #import ltx.host_vm as vm 
    import ltx.mm  as ltx
    
    
    #sleep=ltx.bindObject("module: lib=**;proc=ltx_callback_list::sleepmsg;flags.ftm=1");
    sleep=ltx.ltx_idle
    #print(' ltx_py start...')
    ...
    #vm.__vmref__=__vmref__
    set_vm_ref(__vmref__)
